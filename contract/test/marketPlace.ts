...
describe("marketPlace", function () {
    ...
    it("Should deploy ERC1155 nft contract", async function () {
    ...
    it("Should deploy ERC721 nft contract", async function () {
        const factory = await ethers.getContractFactory("PokeCardERC721");
        PokeCardERC721 = await factory.deploy();
